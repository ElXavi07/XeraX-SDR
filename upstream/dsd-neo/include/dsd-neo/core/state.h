...
struct dsd_state {
    ...
    double analog_activity_m; /* Fresh squelch-open analog block, monotonic seconds. */
    ...
    int receiver_ms_color_known;
    unsigned int dmr_t3_syscode;
    unsigned int nxdn_last_ran;
    unsigned int nxdn_cipher_type;
    unsigned int nxdn_key;
    dsd_nxdn_search_context nxdn_search;
    int nxdn_search_part_valid;
    int nxdn_search_voice_index;
