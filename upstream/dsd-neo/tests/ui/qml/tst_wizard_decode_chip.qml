...
Item {
    ...
    TestCase {
        ...
        readonly property var everyLabel: [
            "Auto — all digital", "Auto — P25/DMR/YSF", "P25 Phase 1 + 2", "P25 Simulcast", "DMR Tier II", "NXDN48",
            "P25 Phase 1 only", "P25 Phase 2 voice",
        ...
        function test_01_a_catalog_flag_selects_its_own_chip() {
            ...
            compare(tc.selectedLabels(), ["P25 Phase 1 + 2"])
        ...
        function test_03_a_scan_list_flag_does_not_collapse_onto_its_base() {
            ...
            compare(tc.chipFor("DMR Tier II"), null,
        ...
        function test_04_an_edacs_import_is_shown_selected() {
            ...
            verify(tc.chipFor("DMR Tier II") !== null)
            verify(tc.chipFor("P25 Simulcast") !== null)
        }
        ...
        function test_06_tapping_a_catalog_chip_replaces_the_imported_flag() {
            ...
            compare(tc.selectedLabels(), ["DMR Tier II"])
        ...
        // XeraX gives the formerly legacy Phase 1 flag a dedicated choice.
        function test_08_phase_one_selects_its_dedicated_chip() {
            tc.wizard.decodeFlag = "-f1"
            compare(tc.selectedLabels(), ["P25 Phase 1 only"],
                    "the Phase 1 flag must select its dedicated chip")
            compare(tc.chipFor("P25 Phase 1 only").modelData.flag, "-f1",
                    "the Phase 1 chip must carry the saved flag")
            verify(tc.chipFor("P25 Simulcast") !== null,
