...
var DECODE_MODES = [
    {label: "AM aviation", short: "AM", flag: "-fU", hint: "AM voice, including aviation. Receive only."},
    {label: "Broadcast FM (mono)", short: "WFM", flag: "-fW", hint: "Wideband FM broadcast audio. Uses 240 kHz RF bandwidth; mono audio."},
    {
        label: "Analog FM (NFM)", short: "NFM", flag: "-fA",
        hint: "VHF/UHF two-way analog FM voice. Digital auto modes do not play analog audio."
    },
    {
        label: "Auto — all digital", short: "Auto all", flag: "-fa",
        hint: "Searches all supported rates, including NXDN48/96 and P25 Phase 2. Select a known protocol for faster acquisition."
    },
    {
    ...
    },
    {
        ...
        label: "P25 Phase 1 + 2", short: "P25", flag: "-ft", trunked: true,
        hint: "Follows P25 control channels and Phase 1 or Phase 2 voice grants."
    },
    {
    ...
    {
        label: "DMR Tier II", short: "DMR", flag: "-fs",
        hint: "Two-slot DMR voice with color code, talkgroup/contact and source radio IDs."
    },
    {
        label: "DMR single-slot", short: "DMR mono", flag: "-fr",
        hint: "Alternative single-slot DMR decoder. Use DMR Tier II to decode both slots."
    },
    {
        label: "P25 Phase 1 only", short: "P25 P1", flag: "-f1",
        hint: "Conventional P25 Phase 1 voice. For a trunked system, choose P25 Phase 1 + 2."
    },
    {
        label: "P25 Phase 2 voice", short: "P25 P2", flag: "-f2 -mq",
        hint: "A parked Phase 2 voice channel. May require WACN, system ID and NAC in advanced options; use Phase 1 + 2 to follow a trunked system."
    },
    {
        label: "NXDN48", short: "NXDN48", flag: "-fi",
        hint: "NXDN 4800 bit/s · 6.25 kHz channel · NEXEDGE / IDAS."
    },
    {
        label: "NXDN96", short: "NXDN96", flag: "-fn",
        hint: "NXDN 9600 bit/s · 12.5 kHz channel · NEXEDGE."
    },
    {
    ...
    {
        label: "dPMR", short: "dPMR", flag: "-fm",
        hint: "6.25 kHz digital voice. Select dPMR explicitly for a known dPMR channel."
    },
    {
        label: "X2-TDMA", short: "X2", flag: "-fx",
        hint: "Legacy X2-TDMA digital voice; separate from standard DMR and P25 Phase 2."
    },
    {
        label: "ProVoice", short: "ProVoice", flag: "-fp", setupOnly: true,
        hint: "Parked ProVoice traffic channel. Use an EDACS choice and a channel map to follow its trunked system."
    },
    {
        label: "EDACS / ProVoice", short: "EDACS", flag: "-fh", trunked: true, setupOnly: true,
        hint: "Standard EDACS control channel and ProVoice. Import the site's correct LCN-to-frequency channel map."
    },
    {
        label: "EDACS / ESK", short: "EDACS ESK", flag: "-fH", trunked: true, setupOnly: true,
        hint: "Standard EDACS with ESK 0xA0. Requires the matching site variant and LCN channel map."
    },
    {
        label: "EDACS Extended Addressing", short: "EDACS EA", flag: "-fe", trunked: true, setupOnly: true,
        hint: "EDACS Extended Addressing and ProVoice; requires a correct LCN channel map."
    },
    {
        label: "EDACS EA / ESK", short: "EA ESK", flag: "-fE", trunked: true, setupOnly: true,
        hint: "EDACS Extended Addressing with ESK 0xA0; requires the correct site variant and LCN channel map."
    }
]
...
//
// EDACS variants are available in setup; these aliases also recognize older
// imports. The custom-AFS forms
...
// the catalog has no entry it refines.
//
...
function decryptionProtocol(flags) {
    ...
    if (value.indexOf("-fs") >= 0 || value.indexOf("-fr") >= 0) return "dmr"
    if (value.indexOf("-fi") >= 0 || value.indexOf("-fn") >= 0) return "nxdn"
    if (value.indexOf("-fz") >= 0) return "m17"
    if (value.indexOf("-fm") >= 0) return "dpmr"
