...
Item {
    ...
    NavigationLayer {
        surface: receiverPage
        active: screen.toolsOpen && screen.visible
        onLeave: screen.toolsOpen = false
    }
    ReceiverToolsScreen {
        id: receiverPage
        anchors.fill: parent
        z: 10
        visible: screen.toolsOpen
        enabled: visible
        onClosed: screen.toolsOpen = false
    }
    ...
    PlexFlickable {
        ...
        Column {
            ...
            Column {
                ...
                MicroLabel { text: "Language / Idioma" }
                PlexComboBox {
                    objectName: "languageSelector"
                    width: parent.width
                    model: ["English", "Español"]
                    currentIndex: typeof appLanguage !== "undefined" && appLanguage.language === "es" ? 1 : 0
            ...
            UiPanel {
                ...
                Column {
                    ...
                    DisclosureRow {
                        objectName: "settingsReceiverTools"
                        title: qsTr("Receiver tools")
                        subtitle: qsTr("Quality, channels, clips and audio help")
                        showDivider: true
                        onTapped: screen.toolsOpen = true
                    }
