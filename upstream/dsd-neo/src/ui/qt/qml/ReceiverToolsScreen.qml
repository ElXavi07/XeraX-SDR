...
Item {
    ...
    PlexFlickable {
        ...
        Column {
            ...
            Label { visible: decoderHost.desktopBuild; text: qsTr("Windows supports listening, scanning and optional AI reception investigations. Extra receiver workers, automated capture comparisons and GPS are not included in this preview.") }
