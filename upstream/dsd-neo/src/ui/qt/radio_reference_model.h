...
class RadioReferenceModel : public QObject {
    ...
    Q_PROPERTY(QVariantList conventionalCategories READ conventionalCategories NOTIFY listsChanged)
    Q_PROPERTY(QVariantList conventionalAgencies READ conventionalAgencies NOTIFY listsChanged)
    Q_PROPERTY(QVariantList conventionalFrequencies READ conventionalFrequencies NOTIFY listsChanged)
  ...
  public:
    ...
    QVariantList conventionalCategories() const { return m_conventionalCategories; }
    QVariantList conventionalAgencies() const { return m_conventionalAgencies; }
    QVariantList conventionalFrequencies() const { return m_conventionalFrequencies; }
    Q_INVOKABLE void loadConventional(int kind, int id);
  ...
  private:
    ...
    enum Fetch {
        ...
        FetchTalkgroups,
        FetchTalkgroupCats,
        FetchConvCategories, FetchConvAgencies, FetchConvFrequencies, FetchConvModes
    };
    ...
    QVariantList m_conventionalCategories, m_conventionalAgencies, m_conventionalFrequencies;
    QMap<QString, QString> m_conventionalModes;
