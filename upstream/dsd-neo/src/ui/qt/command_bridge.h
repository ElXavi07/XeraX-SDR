...
class CommandBridge : public QObject {
  ...
  public:
    ...
    Q_INVOKABLE void setRangeScanOwned(bool on) { m_rangeScanOwned=on; }
    Q_INVOKABLE bool rangeTuneHz(unsigned int hz) const;
    Q_INVOKABLE bool rangeDecodeMode(int mode) const;
    ...
    Q_INVOKABLE bool setAutoPpm(bool enabled) const;
