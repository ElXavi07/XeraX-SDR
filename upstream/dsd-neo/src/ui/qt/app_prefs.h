...
class AppPrefs : public QObject {
    ...
    Q_PROPERTY(QString exploreDecodeFlag READ exploreDecodeFlag WRITE setExploreDecodeFlag NOTIFY exploreChanged)
  ...
  public:
    ...
    QString exploreDecodeFlag() const;
    void setExploreDecodeFlag(const QString& flag);
