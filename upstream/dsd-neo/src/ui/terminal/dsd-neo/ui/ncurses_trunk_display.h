...
#ifndef DSD_NEO_INCLUDE_DSD_NEO_UI_NCURSES_TRUNK_DISPLAY_H_
#define DSD_NEO_INCLUDE_DSD_NEO_UI_NCURSES_TRUNK_DISPLAY_H_
...
#endif /* DSD_NEO_INCLUDE_DSD_NEO_UI_NCURSES_TRUNK_DISPLAY_H_ */
