...
find_library(
    ...
    HINTS ${PC_PORTAUDIO_LIBDIR} ${PC_PORTAUDIO_LIBRARY_DIRS} ${PORTAUDIO_ROOT}
    ENV PORTAUDIO_ROOT
...
elseif(PORTAUDIO_INCLUDE_DIR AND EXISTS "${PORTAUDIO_INCLUDE_DIR}/portaudio.h")
    ...
    file(
        STRINGS "${PORTAUDIO_INCLUDE_DIR}/portaudio.h"
        _pa_version_line
        REGEX "^#define[\t ]+paVersion[\t ]+[0-9]+"
    )
    if(_pa_version_line)
        string(
            REGEX REPLACE "^#define[\t ]+paVersion[\t ]+([0-9]+).*"
            "\\1"
            PORTAUDIO_VERSION_STRING
            "${_pa_version_line}"
        )
    endif()
    ...
    if(NOT TARGET PortAudio::PortAudio)
        ...
        if(WIN32)
            set_property(
                ...
                APPEND
                PROPERTY INTERFACE_LINK_LIBRARIES winmm ole32 uuid setupapi
            )
        endif()
    endif()
endif()
