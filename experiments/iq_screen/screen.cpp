...
// Schema 4 measurement profile copied from frozen schema 3; keep older observers unchanged.
...
int main(int argc,char** argv) {
    try {
        ...
        auto& out=std::cout;out<<"{\"schema_version\":4,\"variant\":";quoted(out,o.variant);out<<",\"format\":";quoted(out,o.format);out<<",\"duration_ms\":"<<o.duration<<",\"producer_period_ns\":"<<period<<",\"request_period_ns\":"<<request_period<<",\"snapshot_samples\":"<<window<<",\"deadline_ns\":"<<deadline_span<<",\"width\":"<<width<<",\"rate_hz\":"<<rate<<",\"stream_id\":1,\"epoch\":1,\"frequency_hz\":451100000,\"prefill_iterations\":"<<prefill_count<<",\"expected_owner_iterations\":"<<owner_count<<",\"expected_requests\":"<<request_count<<",\"completed_owner_iterations\":"<<completed_owner<<",\"completed_requests\":"<<completed_requests<<",\"accepted\":"<<accepted<<",\"verified\":"<<verified<<",\"eligible\":"<<eligible<<",\"complete\":"<<(complete?"true":"false")<<",\"shutdown_acknowledged\":"<<(ack?"true":"false")<<",\"fault\":";quoted(out,o.fault);
